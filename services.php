...
<body>
    <header>
      ...
      <div class="banner">
        <div class="content">
            <h2>Our Passion</h2>
            <p class="pagee">We know that one size does not fit all. Our customers' success from success/stems from making
                each employee recognition program match each organization, down to the details. We work to
                understand the uniqueness of your organization and vision so we can set up and support your
                success, every day.
            </p>     
        </div>
